  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {SaltWeb.LayoutView, "live.html"}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: SaltWeb.Endpoint,
        router: SaltWeb.Router
        #statics: SaltWeb.static_paths()
    end
  end
  @doc """
